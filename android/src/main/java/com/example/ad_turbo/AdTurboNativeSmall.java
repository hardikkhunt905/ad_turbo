...
class AdTurboNativeSmall implements GoogleMobileAdsPlugin.NativeAdFactory {

    private final Context context;

    AdTurboNativeSmall(Context context) {
        this.context = context;
    }


    public NativeAdView createNativeAd(NativeAd nativeAd, Map<String, Object> customOptions) {
        NativeAdView nativeAdView = (NativeAdView) LayoutInflater.from(context).inflate(R.layout.ad_turbo_native_small, null);
