 ...
 */
public class AdTurboTemplate extends FrameLayout {

    private static final String MEDIUM_TEMPLATE = "medium_template";
    private static final String SMALL_TEMPLATE = "small_template";
    private int templateType;
    private AdTurboNativeTemplate styles;
    ...
    public AdTurboTemplate(Context context) {
        super(context);
    }

    public AdTurboTemplate(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public AdTurboTemplate(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    @SuppressLint("NewApi")
    public AdTurboTemplate(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        initView(context, attrs);
    }

    public void setStyles(AdTurboNativeTemplate styles) {
        this.styles = styles;
        this.applyStyles();
    }
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.ad_turbo_medium_template) {
            return MEDIUM_TEMPLATE;
        } else if (templateType == R.layout.ad_turbo_native_small_template) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            R.styleable.TemplateView_gnt_template_type, R.layout.ad_turbo_medium_template);
        } finally {
            attributes.recycle();
        }
